...
name|state
operator|->
name|saved_error_routine
operator|=
name|get_error_routine
argument_list|()
expr_stmt|;
name|state
operator|->
name|saved_warn_routine
operator|=
name|get_warn_routine
argument_list|()
expr_stmt|;
...
begin_function
DECL|function|check_unsafe_path
specifier|static
name|int
name|check_unsafe_path
parameter_list|(
name|struct
name|patch
modifier|*
...
begin_function
DECL|function|read_apply_cache
specifier|static
name|int
name|read_apply_cache
parameter_list|(
name|struct
name|apply_state
modifier|*
...
begin_comment
comment|/* This function tries to read the object name from the current index */
end_comment

begin_function
DECL|function|get_current_oid
specifier|static
name|int
name|get_current_oid
parameter_list|(
name|struct
name|apply_state
modifier|*
...
begin_function
DECL|function|preimage_oid_in_gitlink_patch
specifier|static
name|int
name|preimage_oid_in_gitlink_patch
parameter_list|(
name|struct
name|patch
modifier|*
...
begin_comment
comment|/*  * Returns:  *  -1 if an unrecoverable error happened  *   0 if everything went well  *   1 if a recoverable error happened  */
end_comment
...
begin_comment
comment|/*  * Returns:  *  -1 if an error happened  *   0 if the patch applied cleanly  *   1 if the patch did not apply cleanly  */
end_comment
...
begin_function
DECL|function|apply_parse_options
name|int
