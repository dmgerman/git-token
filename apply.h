...
name|fn_table
decl_stmt|;
comment|/* 	 * This is to save reporting routines before using 	 * set_error_routine() or set_warn_routine() to install muting 	 * routines when in verbosity_silent mode. 	 */
DECL|member|saved_error_routine
name|void
function_decl|(
modifier|*
...
parameter_list|)
function_decl|;
DECL|member|saved_warn_routine
name|void
function_decl|(
modifier|*
