...
begin_comment
comment|/*  * Like strbuf_append_ext_header, but for numeric values.  */
end_comment

begin_function
DECL|function|strbuf_append_ext_header_uint
specifier|static
name|void
...
index|]
decl_stmt|;
comment|/* big enough for 2^128 in decimal, plus NUL */
name|int
name|len
decl_stmt|;
name|len
