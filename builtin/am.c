...
begin_comment
comment|/**  * Take a series of KEY='VALUE' lines where VALUE part is  * sq-quoted, and append<KEY, VALUE> at the end of the string list  */
end_comment

begin_function
DECL|function|parse_key_value_squoted
specifier|static
name|int
name|parse_key_value_squoted
parameter_list|(
name|char
modifier|*
name|buf
...
begin_function
DECL|function|get_mail_commit_oid
specifier|static
name|int
name|get_mail_commit_oid
parameter_list|(
name|struct
name|object_id
modifier|*
...
name|die
argument_list|(
literal|"BUG: init_apply_state() failed"
argument_list|)
expr_stmt|;
name|argv_array_push
argument_list|(
...
name|die
argument_list|(
literal|"unknown option passed through to git apply"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die
argument_list|(
literal|"BUG: check_apply_state() failed"
argument_list|)
expr_stmt|;
name|argv_array_push
argument_list|(
...
condition|)
block|{
comment|/* Reload index as apply_all_patches() will have modified it. */
name|discard_cache
argument_list|()
expr_stmt|;
