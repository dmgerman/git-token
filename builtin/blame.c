...
condition|)
empty_stmt|;
comment|/* path is in the index, unmerged */
else|else
name|die
argument_list|(
...
begin_function
DECL|function|dwim_reverse_initial
specifier|static
specifier|const
name|char
modifier|*
name|dwim_reverse_initial
parameter_list|(
name|struct
name|scoreboard
modifier|*
...
parameter_list|)
block|{
comment|/* 	 * DWIM "git blame --reverse ONE -- PATH" as 	 * "git blame --reverse ONE..HEAD -- PATH" but only do so 	 * when it makes sense. 	 */
name|struct
name|object
modifier|*
name|obj
...
name|NULL
return|;
comment|/* Is that sole rev a committish? */
name|obj
operator|=
name|sb
operator|->
...
name|NULL
return|;
comment|/* Turn "ONE" into "ONE..HEAD" then */
name|obj
operator|->
name|flags
operator||=
...
argument_list|)
block|,
comment|/* 		 * The following two options are parsed by parse_revision_opt() 		 * and are only included here to get included in the "-h" 		 * output: 		 */
block|{
name|OPTION_LOWLEVEL_CALLBACK
block|,
literal|0
block|,
literal|"indent-heuristic"
block|,
name|NULL
block|,
name|NULL
...
name|N_
argument_list|(
literal|"Use an experimental indent-based heuristic to improve diffs"
argument_list|)
block|,
...
name|N_
argument_list|(
literal|"Use an experimental blank-line-based heuristic to improve diffs"
argument_list|)
block|,
name|PARSE_OPT_NOARG
block|,
