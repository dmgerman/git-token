...
name|cmdmode
decl_stmt|;
comment|/* may be 'w' or 'c' for --filters or --textconv */
DECL|member|format
specifier|const
name|char
modifier|*
...
name|die
argument_list|(
literal|"git cat-file --filters %s:<object> must be "
literal|"<sha1:path>"
argument_list|,
name|obj_name
argument_list|)
...
name|N_
argument_list|(
literal|"git cat-file (-t [--allow-unknown-type] | -s [--allow-unknown-type] | -e | -p |<type> | --textconv | --filters) [--path=<path>]<object>"
argument_list|)
block|,
name|N_
argument_list|(
literal|"git cat-file (--batch | --batch-check) [--follow-symlinks] [--textconv | --filters]"
argument_list|)
block|,
name|NULL
block|}
...
name|N_
argument_list|(
literal|"for blob objects, run filters on object's content"
argument_list|)
argument_list|,
literal|'w'
argument_list|)
...
name|N_
argument_list|(
literal|"use a specific path for --textconv/--filters"
argument_list|)
argument_list|)
block|,
name|OPT_BOOL
...
name|die
argument_list|(
literal|"--batch-all-objects cannot be combined with "
literal|"--textconv nor with --filters"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|error
argument_list|(
literal|"--path=<path> needs --textconv or --filters"
argument_list|)
expr_stmt|;
name|usage_with_options
argument_list|(
...
name|error
argument_list|(
literal|"--path=<path> incompatible with --batch"
argument_list|)
expr_stmt|;
name|usage_with_options
argument_list|(
