...
begin_decl_stmt
DECL|variable|option_optional_reference
specifier|static
name|struct
name|string_list
name|option_optional_reference
init|=
name|STRING_LIST_INIT_NODUP
decl_stmt|;
end_decl_stmt
...
name|_
argument_list|(
literal|"info: Could not add alternate for '%s': %s\n"
argument_list|)
argument_list|,
name|item
operator|->
...
name|warning
argument_list|(
literal|"skipping invalid relative alternate: %s/%s"
argument_list|,
name|src_repo
argument_list|,
name|line
...
name|_
argument_list|(
literal|"clone --recursive is not compatible with "
literal|"both --reference and --reference-if-able"
argument_list|)
argument_list|)
expr_stmt|;
elseif|else
...
name|option_config
argument_list|,
literal|"submodule.alternateLocation=superproject"
argument_list|)
expr_stmt|;
name|string_list_append
argument_list|(
...
name|option_config
argument_list|,
literal|"submodule.alternateErrorStrategy=die"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|option_config
argument_list|,
literal|"submodule.alternateErrorStrategy=info"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|_
argument_list|(
literal|"--shallow-exclude is ignored in local clones; use file:// instead."
argument_list|)
argument_list|)
expr_stmt|;
if|if
