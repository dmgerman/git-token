...
begin_function
DECL|function|adjust_refcol_width
specifier|static
name|void
name|adjust_refcol_width
parameter_list|(
specifier|const
name|struct
name|ref
...
name|len
decl_stmt|;
comment|/* uptodate lines are only shown on high verbosity level */
if|if
condition|(
operator|!
name|verbosity
...
argument_list|)
expr_stmt|;
comment|/* 	 * rough estimation to see if the output line is too long and 	 * should not be counted (we can't do precise calculation 	 * anyway because we don't know if the error explanation part 	 * will be printed in update_local_ref) 	 */
if|if
condition|(
name|compact_format
condition|)
...
condition|)
return|return;
comment|/* 	 * Not precise calculation for compact mode because '*' can 	 * appear on the left hand side of '->' and shrink the column 	 * back. 	 */
if|if
condition|(
name|refcol_width
operator|<
...
begin_function
DECL|function|prepare_format_display
specifier|static
name|void
name|prepare_format_display
parameter_list|(
name|struct
name|ref
modifier|*
...
name|_
argument_list|(
literal|"configuration fetch.output contains invalid value %s"
argument_list|)
argument_list|,
name|format
argument_list|)
...
begin_function
DECL|function|print_remote_to_local
specifier|static
name|void
name|print_remote_to_local
parameter_list|(
name|struct
name|strbuf
modifier|*
...
begin_function
DECL|function|find_and_replace
specifier|static
name|int
...
name|_
argument_list|(
literal|"Negative depth in --deepen is not supported"
argument_list|)
argument_list|)
expr_stmt|;
if|if
...
name|_
argument_list|(
literal|"--deepen and --depth are mutually exclusive"
argument_list|)
argument_list|)
expr_stmt|;
name|depth
