...
expr_stmt|;
block|}
comment|/* 	 * We need to create a "refs" dir in any case so that older 	 * versions of git can tell that this is a repository. 	 */
name|safe_create_dir
argument_list|(
name|git_path
argument_list|(
...
name|die
argument_list|(
literal|"failed to set up refs db: %s"
argument_list|,
name|err
operator|.
name|buf
