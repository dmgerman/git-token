...
begin_struct
DECL|struct|submodule_alternate_setup
struct|struct
name|submodule_alternate_setup
block|{
DECL|member|submodule_name
specifier|const
name|char
modifier|*
name|submodule_name
decl_stmt|;
DECL|enum|SUBMODULE_ALTERNATE_ERROR_MODE
enum|enum
name|SUBMODULE_ALTERNATE_ERROR_MODE
block|{
DECL|enumerator|SUBMODULE_ALTERNATE_ERROR_DIE
name|SUBMODULE_ALTERNATE_ERROR_DIE
block|,
DECL|enumerator|SUBMODULE_ALTERNATE_ERROR_INFO
name|SUBMODULE_ALTERNATE_ERROR_INFO
block|,
DECL|enumerator|SUBMODULE_ALTERNATE_ERROR_IGNORE
name|SUBMODULE_ALTERNATE_ERROR_IGNORE
DECL|member|error_mode
block|}
name|error_mode
enum|;
...
begin_define
DECL|macro|SUBMODULE_ALTERNATE_SETUP_INIT
define|#
directive|define
name|SUBMODULE_ALTERNATE_SETUP_INIT
value|{ NULL, \ 	SUBMODULE_ALTERNATE_ERROR_IGNORE, NULL }
end_define

begin_function
DECL|function|add_possible_reference_from_superproject
specifier|static
name|int
name|add_possible_reference_from_superproject
parameter_list|(
name|struct
...
argument_list|)
expr_stmt|;
comment|/* 	 * If the alternate object store is another repository, try the 	 * standard layout with .git/modules/<name>/objects 	 */
if|if
condition|(
name|ends_with
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* 		 * We need to end the new path with '/' to mark it as a dir, 		 * otherwise a submodule name containing '/' will be broken 		 * as the last part of a missing submodule reference would 		 * be taken as a file name. 		 */
name|strbuf_addf
argument_list|(
operator|&
name|sb
...
name|_
argument_list|(
literal|"submodule '%s' cannot add alternate: %s"
argument_list|)
argument_list|,
name|sas
operator|->
...
begin_function
DECL|function|prepare_possible_alternates
specifier|static
name|void
name|prepare_possible_alternates
parameter_list|(
specifier|const
name|char
modifier|*
...
name|git_config_get_string
argument_list|(
literal|"submodule.alternateLocation"
argument_list|,
operator|&
name|sm_alternate
argument_list|)
...
name|git_config_get_string
argument_list|(
literal|"submodule.alternateErrorStrategy"
argument_list|,
operator|&
name|error_strategy
argument_list|)
...
name|_
argument_list|(
literal|"Value '%s' for submodule.alternateErrorStrategy is not recognized"
argument_list|)
argument_list|,
name|error_strategy
argument_list|)
...
name|_
argument_list|(
literal|"Value '%s' for submodule.alternateLocation is not recognized"
argument_list|)
argument_list|,
name|sm_alternate
argument_list|)
...
literal|1
decl_stmt|;
comment|/* failed clones to be retried again */
DECL|member|failed_clones
specifier|const
name|struct
name|cache_entry
modifier|*
...
name|failed_clones
decl_stmt|;
DECL|member|failed_clones_nr
DECL|member|failed_clones_alloc
name|int
name|failed_clones_nr
decl_stmt|,
name|failed_clones_alloc
decl_stmt|;
block|}
struct|;
end_struct
...
block|}
block|}
comment|/* 	 * The loop above tried cloning each submodule once, now try the 	 * stragglers again, which we can imagine as an extension of the 	 * entry list. 	 */
name|index
operator|=
name|suc
operator|->
...
name|_
argument_list|(
literal|"Failed to clone '%s'. Retry scheduled"
argument_list|)
argument_list|,
name|ce
operator|->
...
name|_
argument_list|(
literal|"Failed to clone '%s' a second time, aborting"
argument_list|)
argument_list|,
name|ce
operator|->
...
begin_function
DECL|function|remote_submodule_branch
specifier|static
specifier|const
name|char
modifier|*
name|remote_submodule_branch
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"Submodule (%s) branch configured to inherit "
literal|"branch from superproject, but the superproject "
literal|"is not on any branch"
argument_list|)
argument_list|,
name|sub
operator|->
...
begin_function
DECL|function|resolve_remote_submodule_branch
specifier|static
name|int
name|resolve_remote_submodule_branch
parameter_list|(
name|int
name|argc
parameter_list|,
...
name|die
argument_list|(
literal|"submodule--helper remote-branch takes exactly one arguments, got %d"
argument_list|,
name|argc
argument_list|)
expr_stmt|;
...
name|die
argument_list|(
literal|"submodule %s doesn't exist"
argument_list|,
name|argv
index|[
literal|1
