...
name|N_
argument_list|(
literal|"git worktree lock [<options>]<path>"
argument_list|)
block|,
name|N_
argument_list|(
...
name|N_
argument_list|(
literal|"git worktree unlock<path>"
argument_list|)
block|,
name|NULL
block|}
...
name|_
argument_list|(
literal|"'%s' is not a working tree"
argument_list|)
argument_list|,
name|av
index|[
...
name|_
argument_list|(
literal|"The main working tree cannot be locked or unlocked"
argument_list|)
argument_list|)
expr_stmt|;
name|old_reason
...
name|_
argument_list|(
literal|"'%s' is already locked, reason: %s"
argument_list|)
argument_list|,
name|av
index|[
...
begin_function
DECL|function|unlock_worktree
specifier|static
name|int
name|unlock_worktree
parameter_list|(
name|int
name|ac
parameter_list|,
