...
begin_define
DECL|macro|GIT_QUARANTINE_ENVIRONMENT
define|#
directive|define
name|GIT_QUARANTINE_ENVIRONMENT
value|"GIT_QUARANTINE_PATH"
end_define
...
begin_function
DECL|function|is_empty_blob_oid
specifier|static
specifier|inline
name|int
name|is_empty_blob_oid
parameter_list|(
specifier|const
name|struct
name|object_id
...
begin_function
DECL|function|is_empty_tree_sha1
specifier|static
specifier|inline
name|int
name|is_empty_tree_sha1
parameter_list|(
specifier|const
name|unsigned
name|char
...
begin_function
DECL|function|is_empty_tree_oid
specifier|static
specifier|inline
name|int
name|is_empty_tree_oid
parameter_list|(
specifier|const
name|struct
name|object_id
...
begin_comment
comment|/*  * Convert two consecutive hexadecimal digits into a char.  Return a  * negative value on error.  Don't run over the end of short strings.  */
end_comment

begin_function
DECL|function|hex2chr
specifier|static
specifier|inline
name|int
name|hex2chr
...
begin_comment
comment|/*  * Add the directory to the in-memory list of alternates (along with any  * recursive alternates it points to), but do not modify the on-disk alternates  * file.  */
end_comment
...
begin_comment
comment|/*  * Returns a scratch strbuf pre-filled with the alternate object directory,  * including a trailing slash, which can be used to access paths in the  * alternate. Always use this over direct access to alt->scratch, as it  * cleans up any previous use of the scratch buffer.  */
end_comment
...
begin_enum
DECL|enum|config_origin_type
enum|enum
name|config_origin_type
block|{
DECL|enumerator|CONFIG_ORIGIN_BLOB
name|CONFIG_ORIGIN_BLOB
block|,
DECL|enumerator|CONFIG_ORIGIN_FILE
name|CONFIG_ORIGIN_FILE
block|,
DECL|enumerator|CONFIG_ORIGIN_STDIN
name|CONFIG_ORIGIN_STDIN
block|,
DECL|enumerator|CONFIG_ORIGIN_SUBMODULE_BLOB
name|CONFIG_ORIGIN_SUBMODULE_BLOB
block|,
DECL|enumerator|CONFIG_ORIGIN_CMDLINE
name|CONFIG_ORIGIN_CMDLINE
block|}
enum|;
end_enum
