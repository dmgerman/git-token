...
name|v
parameter_list|)
value|dummy_decl_mingw_main(); \ static int mingw_main(c,v); \ int main(int argc, const char **argv) \ { \ 	mingw_startup(); \ 	return mingw_main(__argc, (void *)__argv); \ } \ static int mingw_main(c,v)
end_define
