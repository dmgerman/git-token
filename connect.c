...
decl_stmt|;
name|int
name|got_dummy_ref_with_capabilities_declaration
init|=
literal|0
decl_stmt|;
operator|*
...
name|die
argument_list|(
literal|"protocol error: unexpected capabilities^{}"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|die
argument_list|(
literal|"protocol error: multiple capabilities^{}"
argument_list|)
expr_stmt|;
name|got_dummy_ref_with_capabilities_declaration
operator|=
...
name|die
argument_list|(
literal|"protocol error: unexpected ref after capabilities^{}"
argument_list|)
expr_stmt|;
name|ref
operator|=
