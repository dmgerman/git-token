...
condition|)
block|{
comment|/* 		 * CRLFs would not be restored by checkout 		 */
if|if
condition|(
name|checksafe
operator|==
...
condition|)
block|{
comment|/* 		 * CRLFs would be added by checkout 		 */
if|if
condition|(
name|checksafe
operator|==
...
begin_function
DECL|function|will_convert_lf_to_crlf
specifier|static
name|int
name|will_convert_lf_to_crlf
parameter_list|(
name|size_t
name|len
parameter_list|,
