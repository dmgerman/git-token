...
begin_function
DECL|function|put_object_name
specifier|static
name|void
name|put_object_name
parameter_list|(
name|struct
name|fsck_options
modifier|*
...
block|{
comment|/* parse ~<generation> suffix */
for|for
control|(
name|generation
operator|=
...
argument_list|,
literal|"cannot be parsed as a tree"
argument_list|)
expr_stmt|;
return|return
name|retval
