...
begin_function
DECL|function|graph_show_line_prefix
specifier|static
name|void
name|graph_show_line_prefix
parameter_list|(
specifier|const
name|struct
name|diff_options
...
begin_decl_stmt
DECL|variable|default_diffopt
specifier|static
specifier|const
name|struct
name|diff_options
modifier|*
name|default_diffopt
decl_stmt|;
end_decl_stmt

begin_function
DECL|function|graph_setup_line_prefix
name|void
...
name|diffopt
expr_stmt|;
comment|/* setup an output prefix callback if necessary */
if|if
condition|(
name|diffopt
operator|&&
