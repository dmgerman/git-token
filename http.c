...
name|name
decl_stmt|;
DECL|member|curl_deleg_param
name|long
name|curl_deleg_param
decl_stmt|;
DECL|variable|curl_deleg_levels
block|}
name|curl_deleg_levels
index|[]
init|=
block|{
block|{
...
begin_function
DECL|function|xmulti_remove_handle
specifier|static
name|void
...
name|_
argument_list|(
literal|"Delegation control is not supported with cURL< 7.22.0"
argument_list|)
argument_list|)
expr_stmt|;
return|return
...
name|warning
argument_list|(
literal|"Unknown delegation method '%s': using default"
argument_list|,
name|curl_deleg
argument_list|)
expr_stmt|;
...
name|die
argument_list|(
literal|"BUG: curl_easy_getinfo for HTTP code failed: %s"
argument_list|,
name|curl_easy_strerror
argument_list|(
name|c
