...
begin_function
DECL|function|unquote_comment
specifier|static
specifier|const
name|char
modifier|*
name|unquote_comment
parameter_list|(
name|struct
name|strbuf
modifier|*
...
begin_function
DECL|function|unquote_quoted_string
specifier|static
specifier|const
name|char
modifier|*
name|unquote_quoted_string
parameter_list|(
name|struct
name|strbuf
modifier|*
...
begin_function
DECL|function|unquote_quoted_pair
specifier|static
name|void
name|unquote_quoted_pair
parameter_list|(
name|struct
name|strbuf
modifier|*
...
begin_comment
comment|/*  * Returns 1 if the given line or any line beginning with the given line is an  * in-body header (that is, check_header will succeed when passed  * mi->s_hdr_data).  */
end_comment

begin_function
DECL|function|is_inbody_header
specifier|static
name|int
name|is_inbody_header
parameter_list|(
specifier|const
name|struct
name|mailinfo
...
begin_function
DECL|function|flush_inbody_header_accum
specifier|static
name|void
name|flush_inbody_header_accum
parameter_list|(
name|struct
name|mailinfo
modifier|*
...
begin_function
DECL|function|check_inbody_header
specifier|static
name|int
name|check_inbody_header
parameter_list|(
name|struct
name|mailinfo
modifier|*
...
condition|)
block|{
comment|/* 			 * This is a scissors line; do not consider this line 			 * as a header continuation line. 			 */
name|flush_inbody_header_accum
argument_list|(
name|mi
argument_list|)
