...
begin_function
DECL|function|patch_id_defined
specifier|static
name|int
name|patch_id_defined
parameter_list|(
name|struct
name|commit
modifier|*
...
parameter_list|)
block|{
comment|/* must be 0 or 1 parents */
return|return
operator|!
name|commit
operator|->
...
name|error
argument_list|(
literal|"Could not get patch ID for %s"
argument_list|,
name|oid_to_hex
argument_list|(
operator|&
