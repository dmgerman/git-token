...
begin_function
DECL|function|basic_regex_quote_buf
name|void
...
condition|)
block|{
comment|/* only beginning '^' is special and needs quoting */
name|strbuf_addch
argument_list|(
name|sb
argument_list|,
...
literal|'*'
condition|)
comment|/* beginning '*' is not special, no quoting */
name|strbuf_addch
argument_list|(
name|sb
argument_list|,
...
literal|'$'
case|:
comment|/* only the end '$' is special and needs quoting */
if|if
condition|(
operator|*
name|src
