...
begin_comment
comment|/*  * Chmod an index entry with either +x or -x.  *  * Returns -1 if the chmod for the particular cache entry failed (if it's  * not a regular file), -2 if an invalid flip argument is passed in, 0  * otherwise.  */
end_comment

begin_function
DECL|function|chmod_index_entry
name|int
