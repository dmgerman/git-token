...
begin_comment
comment|/*  * List of all available backends  */
end_comment

begin_decl_stmt
DECL|variable|refs_backends
specifier|static
name|struct
name|ref_storage_be
modifier|*
...
begin_function
DECL|function|find_ref_storage_backend
specifier|static
name|struct
name|ref_storage_be
modifier|*
name|find_ref_storage_backend
parameter_list|(
specifier|const
name|char
modifier|*
...
begin_function
DECL|function|ref_storage_backend_exists
name|int
...
argument_list|)
decl_stmt|;
comment|/* rest must not be empty, or start or end with "/" */
if|if
condition|(
operator|!
name|restlen
...
begin_function
DECL|function|ref_transaction_add_update
name|struct
name|ref_update
modifier|*
...
begin_function
DECL|function|resolve_ref_recursively
specifier|static
specifier|const
name|char
modifier|*
name|resolve_ref_recursively
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_comment
comment|/* backend functions */
end_comment

begin_function
DECL|function|refs_init_db
name|int
name|refs_init_db
parameter_list|(
name|struct
...
condition|)
block|{
comment|/* We need to strip off one or more trailing slashes */
name|char
modifier|*
name|stripped
init|=
...
begin_comment
comment|/* A pointer to the ref_store for the main repository: */
end_comment

begin_decl_stmt
DECL|variable|main_ref_store
specifier|static
name|struct
name|ref_store
modifier|*
...
begin_comment
comment|/* A linked list of ref_stores for submodules: */
end_comment
...
begin_function
DECL|function|base_ref_store_init
name|void
...
name|die
argument_list|(
literal|"BUG: main_ref_store initialized twice"
argument_list|)
expr_stmt|;
name|refs
operator|->
...
name|die
argument_list|(
literal|"BUG: ref_store for submodule '%s' initialized twice"
argument_list|,
name|submodule
argument_list|)
expr_stmt|;
...
name|die
argument_list|(
literal|"BUG: reference backend %s is unknown"
argument_list|,
name|be_name
argument_list|)
expr_stmt|;
...
begin_function
DECL|function|assert_main_repository
name|void
...
name|die
argument_list|(
literal|"BUG: %s called for a submodule"
argument_list|,
name|caller
argument_list|)
expr_stmt|;
