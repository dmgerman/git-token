...
begin_comment
comment|/* reflog functions */
end_comment

begin_comment
comment|/*  * Iterate over the references in the specified ref_store that have a  * reflog. The refs are iterated over in arbitrary order.  */
end_comment

begin_typedef
DECL|typedef|reflog_iterator_begin_fn
typedef|typedef
name|struct
name|ref_iterator
modifier|*
name|reflog_iterator_begin_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|for_each_reflog_ent_fn
typedef|typedef
name|int
name|for_each_reflog_ent_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|for_each_reflog_ent_reverse_fn
typedef|typedef
name|int
name|for_each_reflog_ent_reverse_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|reflog_exists_fn
typedef|typedef
name|int
name|reflog_exists_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|create_reflog_fn
typedef|typedef
name|int
name|create_reflog_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|delete_reflog_fn
typedef|typedef
name|int
name|delete_reflog_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|reflog_expire_fn
typedef|typedef
name|int
name|reflog_expire_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
begin_typedef
DECL|typedef|verify_refname_available_fn
typedef|typedef
name|int
name|verify_refname_available_fn
parameter_list|(
name|struct
name|ref_store
modifier|*
...
name|read_raw_ref
decl_stmt|;
DECL|member|verify_refname_available
name|verify_refname_available_fn
modifier|*
name|verify_refname_available
decl_stmt|;
DECL|member|reflog_iterator_begin
name|reflog_iterator_begin_fn
modifier|*
name|reflog_iterator_begin
decl_stmt|;
DECL|member|for_each_reflog_ent
name|for_each_reflog_ent_fn
modifier|*
name|for_each_reflog_ent
decl_stmt|;
DECL|member|for_each_reflog_ent_reverse
name|for_each_reflog_ent_reverse_fn
modifier|*
name|for_each_reflog_ent_reverse
decl_stmt|;
DECL|member|reflog_exists
name|reflog_exists_fn
modifier|*
name|reflog_exists
decl_stmt|;
DECL|member|create_reflog
name|create_reflog_fn
modifier|*
name|create_reflog
decl_stmt|;
DECL|member|delete_reflog
name|delete_reflog_fn
modifier|*
name|delete_reflog
decl_stmt|;
DECL|member|reflog_expire
name|reflog_expire_fn
modifier|*
name|reflog_expire
decl_stmt|;
