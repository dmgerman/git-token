...
parameter_list|)
block|{
comment|/* hex sha1 plus internal "/" */
name|size_t
name|len
init|=
name|GIT_SHA1_HEXSZ
...
begin_comment
comment|/*  * Return non-zero iff the path is usable as an alternate object database.  */
end_comment

begin_function
DECL|function|alt_odb_usable
specifier|static
name|int
name|alt_odb_usable
parameter_list|(
...
name|error
argument_list|(
literal|"unable to normalize alternate object path: %s"
argument_list|,
name|pathbuf
operator|.
name|buf
...
name|die
argument_list|(
literal|"unable to normalize object directory: %s"
argument_list|,
name|objdirbuf
operator|.
name|buf
...
begin_function
DECL|function|compute_alternate_path
name|char
modifier|*
...
name|_
argument_list|(
literal|"reference repository '%s' as a linked "
literal|"checkout is not supported yet."
argument_list|)
argument_list|,
name|path
argument_list|)
...
name|_
argument_list|(
literal|"reference repository '%s' is not a "
...
begin_decl_stmt
DECL|variable|packed_git_mru_storage
specifier|static
name|struct
name|mru
name|packed_git_mru_storage
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|packed_git_mru
name|struct
name|mru
modifier|*
name|packed_git_mru
...
begin_function
DECL|function|get_next_packed_git
specifier|static
name|void
modifier|*
name|get_next_packed_git
parameter_list|(
specifier|const
name|void
modifier|*
...
begin_function
DECL|function|set_next_packed_git
specifier|static
name|void
name|set_next_packed_git
parameter_list|(
name|void
modifier|*
name|p
...
begin_function
DECL|function|prepare_packed_git_mru
specifier|static
name|void
name|prepare_packed_git_mru
parameter_list|(
name|void
parameter_list|)
block|{
...
begin_function
DECL|function|unpack_sha1_short_header
specifier|static
name|int
name|unpack_sha1_short_header
parameter_list|(
name|git_zstream
modifier|*
name|stream
...
name|status
return|;
comment|/* Make sure we have the terminating NUL */
if|if
condition|(
operator|!
name|memchr
...
begin_struct
DECL|struct|delta_base_cache_key
struct|struct
name|delta_base_cache_key
block|{
DECL|member|p
name|struct
name|packed_git
...
begin_function
DECL|function|delta_base_cache_key_eq
specifier|static
name|int
name|delta_base_cache_key_eq
parameter_list|(
specifier|const
name|struct
name|delta_base_cache_key
...
begin_function
DECL|function|delta_base_cache_hash_cmp
specifier|static
name|int
name|delta_base_cache_hash_cmp
parameter_list|(
specifier|const
name|void
modifier|*
