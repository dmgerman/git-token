...
name|len
decl_stmt|;
comment|/* length of prefix in hex chars */
DECL|member|hex_pfx
name|char
name|hex_pfx
index|[
...
begin_decl_stmt
DECL|variable|default_disambiguate_hint
specifier|static
name|disambiguate_hint_fn
name|default_disambiguate_hint
decl_stmt|;
end_decl_stmt

begin_function
DECL|function|set_disambiguate_hint_config
name|int
...
name|error
argument_list|(
literal|"unknown hint type for '%s': %s"
argument_list|,
name|var
argument_list|,
name|value
...
begin_function
DECL|function|init_object_disambiguation
specifier|static
name|int
name|init_object_disambiguation
parameter_list|(
specifier|const
name|char
modifier|*
...
begin_function
DECL|function|show_ambiguous_object
specifier|static
name|int
name|show_ambiguous_object
parameter_list|(
specifier|const
name|unsigned
name|char
...
argument_list|)
expr_stmt|;
comment|/* 		 * We may still have ambiguity if we simply saw a series of 		 * candidates that did not satisfy our hint function. In 		 * that case, we still want to show them, so disable the hint 		 * function entirely. 		 */
if|if
condition|(
operator|!
name|ds
...
begin_function
DECL|function|collect_ambiguous
specifier|static
name|int
name|collect_ambiguous
parameter_list|(
specifier|const
name|unsigned
name|char
