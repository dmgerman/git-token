...
begin_function
DECL|function|strbuf_normalize_path
name|int
...
return|;
block|}
comment|/* 	 * normalize_path does not tell us the new length, so we have to 	 * compute it by looking for the new NUL it placed 	 */
name|strbuf_setlen
argument_list|(
operator|&
name|dst
