...
begin_function
DECL|function|find_worktree_by_suffix
specifier|static
name|struct
name|worktree
modifier|*
name|find_worktree_by_suffix
parameter_list|(
name|struct
name|worktree
modifier|*
...
name|suffixlen
decl_stmt|;
comment|/* suffix must start at directory boundary */
if|if
condition|(
operator|(
operator|!
...
begin_function
DECL|function|is_worktree_locked
specifier|const
name|char
modifier|*
