...
name|fd
expr_stmt|;
comment|/* 				 * it is OK if this poll() failed; we 				 * want to leave this infinite loop 				 * only when write() returns with 				 * success, or an expected failure, 				 * which would be checked by the next 				 * call to write(2). 				 */
name|poll
argument_list|(
operator|&
name|pfd
