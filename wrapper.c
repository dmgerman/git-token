...
begin_function
DECL|function|handle_nonblock
specifier|static
name|int
name|handle_nonblock
parameter_list|(
name|int
name|fd
parameter_list|,
...
name|poll_events
expr_stmt|;
comment|/* 	 * no need to check for errors, here; 	 * a subsequent read/write will detect unrecoverable errors 	 */
name|poll
argument_list|(
operator|&
name|pfd
