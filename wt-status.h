...
name|score
decl_stmt|;
DECL|member|mode_head
DECL|member|mode_index
DECL|member|mode_worktree
name|int
name|mode_head
decl_stmt|,
name|mode_index
...
name|mode_worktree
decl_stmt|;
DECL|member|oid_head
DECL|member|oid_index
name|struct
name|object_id
name|oid_head
decl_stmt|,
...
block|,
DECL|enumerator|STATUS_FORMAT_PORCELAIN_V2
